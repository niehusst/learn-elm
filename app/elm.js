...
var $author$project$Model$Post$Post = F3(
	function (id, title, author) {
		return {author: author, id: id, title: title};
	});
var $author$project$Model$Author$Author = F2(
	function (name, url) {
...
var $author$project$Model$Author$authorDecoder = A3(
	...
	A3(
		...
		'name',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Model$Author$Author)));
...
var $author$project$Model$Post$PostId = function (a) {
	return {$: 'PostId', a: a};
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Model$Post$postIdDecoder = A2($elm$json$Json$Decode$map, $author$project$Model$Post$PostId, $elm$json$Json$Decode$int);
var $author$project$Model$Post$postDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'author',
	$author$project$Model$Author$authorDecoder,
	{name: 'anon', url: ''},
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'title',
		...
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'id',
			$author$project$Model$Post$postIdDecoder,
			$elm$json$Json$Decode$succeed($author$project$Model$Post$Post))));
var $author$project$Model$Post$postsDecoder = $elm$json$Json$Decode$list($author$project$Model$Post$postDecoder);
...
var $author$project$Main$decodeStoredPosts = function (postsJson) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$Model$Post$postsDecoder, postsJson);
	if (_v0.$ === 'Ok') {
		var posts = _v0.a;
...
var $author$project$Model$Post$idToString = function (_v0) {
	var id = _v0.a;
	return $elm$core$String$fromInt(id);
};
var $author$project$Page$EditPost$serverUrl = 'http://localhost:5019/posts/';
	...
	return $elm$http$Http$get(
		{
			expect: A2(
				...
				$author$project$Model$Post$postDecoder),
			url: _Utils_ap(
				$author$project$Page$EditPost$serverUrl,
				$author$project$Model$Post$idToString(postId))
		});
};
...
var $author$project$Page$ListPosts$DataReceived = function (a) {
...
var $author$project$Page$ListPosts$fetchPosts = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Page$ListPosts$DataReceived),
			$author$project$Model$Post$postsDecoder),
		url: 'http://localhost:5019/posts'
	});
var $author$project$Page$ListPosts$initialModel = function (posts) {
	return {deleteError: $elm$core$Maybe$Nothing, posts: posts};
};
...
var $author$project$Page$ListPosts$init = function (posts) {
	var initialCmd = $krisajenkins$remotedata$RemoteData$isSuccess(posts) ? $elm$core$Platform$Cmd$none : $author$project$Page$ListPosts$fetchPosts;
	return _Utils_Tuple2(
		$author$project$Page$ListPosts$initialModel(posts),
		initialCmd);
};
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Model$Post$emptyPost = {
	author: {name: '', url: ''},
	id: $author$project$Model$Post$PostId(-1),
	title: ''
};
var $author$project$Page$NewPost$init = function (navKey) {
	return _Utils_Tuple2(
		{createError: $elm$core$Maybe$Nothing, navKey: navKey, post: $author$project$Model$Post$emptyPost},
...
var $author$project$Route$CreatePost = {$: 'CreatePost'};
...
var $author$project$Model$Post$idParser = A2(
	$elm$url$Url$Parser$custom,
	'POSTID',
	function (postId) {
		return A2(
			$elm$core$Maybe$map,
			$author$project$Model$Post$PostId,
	...
	_List_fromArray(
		[
			...
			A2(
				...
				$elm$url$Url$Parser$s('posts'),
				$author$project$Model$Post$idParser)),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$CreatePost,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('posts'),
...
var $author$project$Route$routeToString = function (route) {
	switch (route.$) {
		...
		default:
			var postId = route.a;
			return '/posts/' + $author$project$Model$Post$idToString(postId);
	}
};
...
var $author$project$Model$Author$encodeAuthor = function (author) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(author.name)),
				_Utils_Tuple2(
				'url',
				$elm$json$Json$Encode$string(author.url))
			]));
};
var $elm$json$Json$Encode$int = _Json_wrap;
var $author$project$Model$Post$encodeId = function (_v0) {
	var id = _v0.a;
	return $elm$json$Json$Encode$int(id);
};
var $author$project$Model$Post$postEncoder = function (post) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$author$project$Model$Post$encodeId(post.id)),
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(post.title)),
				_Utils_Tuple2(
				'author',
				$author$project$Model$Author$encodeAuthor(post.author))
			]));
};
		...
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Model$Post$postEncoder(postData)),
				expect: A2($elm$http$Http$expectJson, $author$project$Page$EditPost$PostSaved, $author$project$Model$Post$postDecoder),
				headers: _List_Nil,
				method: 'PATCH',
				...
				url: _Utils_ap(
					$author$project$Page$EditPost$serverUrl,
					$author$project$Model$Post$idToString(postData.id))
			});
	} else {
		return $elm$core$Platform$Cmd$none;
	}
};
var $author$project$Model$Post$setAuthor = F2(
	function (fn, post) {
		return _Utils_update(
			post,
			{
				author: fn(post.author)
			});
	});
var $author$project$Model$Author$setName = F2(
	function (name, author) {
		return _Utils_update(
			author,
			{name: name});
	});
var $author$project$Model$Author$setUrl = F2(
	function (url, author) {
		return _Utils_update(
			author,
			{url: url});
			...
			case 'UpdateAuthorName':
				...
				var updateName = A2(
					...
					function (post) {
						return A3(
							$elm$core$Basics$apL,
							$author$project$Model$Post$setAuthor,
							$author$project$Model$Author$setName(newName),
							post);
					},
					model.post);
				return _Utils_Tuple2(
				...
				var updateUrl = A2(
					...
					function (post) {
						return A3(
							$elm$core$Basics$apL,
							$author$project$Model$Post$setAuthor,
							$author$project$Model$Author$setUrl(newUrl),
							post);
					},
					model.post);
				return _Utils_Tuple2(
	...
	return $elm$http$Http$request(
		{
			...
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: 'http://localhost:5019/posts/' + $author$project$Model$Post$idToString(postid)
		});
};
...
var $author$project$Model$Post$savePosts = function (posts) {
	return $author$project$Ports$storePosts(
		A2(
			$elm$json$Json$Encode$encode,
			0,
			A2($elm$json$Json$Encode$list, $author$project$Model$Post$postEncoder, posts)));
};
		...
		switch (msg.$) {
			case 'FetchPosts':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{deleteError: $elm$core$Maybe$Nothing, posts: $krisajenkins$remotedata$RemoteData$Loading}),
			...
			default:
				...
				var savePostsCmd = function () {
					if (response.$ === 'Success') {
						var unwrappedPosts = response.a;
						return $author$project$Model$Post$savePosts(
							A2($krisajenkins$remotedata$RemoteData$withDefault, _List_Nil, response));
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{deleteError: $elm$core$Maybe$Nothing, posts: response}),
					savePostsCmd);
		}
	});
...
var $author$project$Model$Post$newPostEncoder = function (post) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Page$NewPost$createPost = function (post) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Model$Post$newPostEncoder(post)),
			expect: A2($elm$http$Http$expectJson, $author$project$Page$NewPost$PostCreated, $author$project$Model$Post$postDecoder),
			url: 'http://localhost:5019/posts'
		});
};
var $author$project$Model$Post$setTitle = F2(
			...
			case 'StoreTitle':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							post: A2($author$project$Model$Post$setTitle, title, model.post)
						}),
					$elm$core$Platform$Cmd$none);
					...
					_Utils_update(
						model,
						{
							post: A3(
								$elm$core$Basics$apL,
								$author$project$Model$Post$setAuthor,
								$author$project$Model$Author$setName(name),
								model.post)
						}),
					$elm$core$Platform$Cmd$none);
			case 'StoreAuthorUrl':
					...
					_Utils_update(
						model,
						{
							post: A3(
								$elm$core$Basics$apL,
								$author$project$Model$Post$setAuthor,
								$author$project$Model$Author$setUrl(url),
								model.post)
						}),
					$elm$core$Platform$Cmd$none);
			case 'CreatePost':
			...
			default:
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{createError: $elm$core$Maybe$Nothing, post: post}),
						A2($author$project$Route$pushUrl, $author$project$Route$Posts, model.navKey));
				} else {
					var httpError = msg.a.a;
					return _Utils_Tuple2(
			...
			switch (_v0.a.$) {
				...
				default:
					if (_v0.b.$ === 'NewPage') {
						var submsg = _v0.a.a;
						var pageModel = _v0.b.a;
						var _v4 = A2($author$project$Page$NewPost$update, submsg, pageModel);
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$value(post.author.name),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$value(post.author.url),
...
var $author$project$Page$EditPost$viewFetchError = function (errMsg) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('There was a problem fetching the post:')
					])),
...
var $author$project$Page$EditPost$viewSaveError = function (error) {
	if (error.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Couldnt save the post')
						])),
...
var $author$project$Page$ListPosts$viewError = function (error) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('An error occured: ' + error)
					]))
			]));
};
var $author$project$Page$ListPosts$viewDeletionError = function (model) {
	var _v0 = model.deleteError;
	if (_v0.$ === 'Just') {
		var message = _v0.a;
		return $author$project$Page$ListPosts$viewError(message);
	} else {
		return $elm$html$Html$text('');
	}
};
...
var $author$project$Page$ListPosts$viewPost = function (post) {
	var postPath = '/posts/' + $author$project$Model$Post$idToString(post.id);
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Model$Post$idToString(post.id))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href(post.author.url)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(post.author.name)
							]))
					])),
				A2(
				$elm$html$Html$td,
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							A2($elm$core$List$map, $author$project$Page$ListPosts$viewPost, posts)))
					]))
			]));
};
var $author$project$Page$ListPosts$viewPostsOrError = function (model) {
	var _v0 = model.posts;
	switch (_v0.$) {
		case 'NotAsked':
			return $elm$html$Html$text('');
		...
		case 'Success':
			var posts = _v0.a;
			return $author$project$Page$ListPosts$viewPosts(posts);
		default:
			var error = _v0.a;
			return $author$project$Page$ListPosts$viewError(
				$author$project$Error$buildErrorMessage(error));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Refresh data from server')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				...
				$author$project$Page$ListPosts$viewPostsOrError(model),
				$author$project$Page$ListPosts$viewDeletionError(model)
			]));
};
var $author$project$Page$NewPost$viewCreateError = function (error) {
	if (error.$ === 'Just') {
		var message = error.a;
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Error occured while creating post:')
						])),
...
var $author$project$Page$NewPost$viewNewPostForm = A2(
	$elm$html$Html$form,
	_List_Nil,
	_List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Page$NewPost$viewNewPostForm,
				$author$project$Page$NewPost$viewCreateError(model.createError)
			]));
};
	...
	switch (_v0.$) {
		...
		case 'ListPage':
			...
			return A2(
				...
				$author$project$Page$ListPosts$view(listModel));
		case 'EditPage':
			var editModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$EditPageMsg,
				$author$project$Page$EditPost$view(editModel));
		default:
			var newModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$NewPageMsg,
				$author$project$Page$NewPost$view(newModel));
	}
};
